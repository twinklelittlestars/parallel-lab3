//采用neon指令集优化，并且进行了对齐操作，并且采用了静态线程 +barrier 同步多线程方式
#include <iostream>
#include<pthread.h>
#include<stdlib.h>
#include<stdio.h>
...
void Init_R(){
    unsigned int a;
    ifstream infile("/home/data/Groebner/4_1011_539_263/1.txt");
...
void Init_E(){
    unsigned int a;
    ifstream infile("/home/data/Groebner/4_1011_539_263/2.txt");
